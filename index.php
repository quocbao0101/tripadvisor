    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-9 col-lg-9 col-md-9">
                                <div class="hero__caption">
                                    <h1>Vịnh Hạ Long<span></span> </h1>
                                    <br>
                                    <h1 style="font-size: 50px; margin-left: 30%;">Di sản thiên nhiên thế giới</h1>
                                    <p></p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="favourite-place place-padding">
            <div class="container">
                ...
                <?php
                    $conn = mysqli_connect("localhost","root","","tripadvisor");
                        ...
                        <div class="single-place mb-30">
                            ...
                            <div class="place-cap">
                                <div class="place-cap-top">
                                    <span><i class="fas fa-star"></i><span><?php echo $row['TongDanhGia'] ?></span></span>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="video-caption text-center">
                            <p class="pera1">Content 1</p>
                            <p class="pera2">Content 2</p>
                            <p class="pera3"> Content 3</p>
                        </div>
                    </div>
                </div>
            </div>
